...
app id: ca-app-pub-8703660804731523~1704327816

Banner ads unit: ca-app-pub-8703660804731523/6317420894
Interstitial ads unit: ca-app-pub-8703660804731523/8736690355
Rewarded interstitial ads unit: ca-app-pub-8703660804731523/7998273427
Rewarded ads unit: ca-app-pub-8703660804731523/8928211716
Native advanced ads unit: ca-app-pub-8703660804731523/5930408082

IOS 

app id: ca-app-pub-8703660804731523~9032203826
Banner ads unit: ca-app-pub-8703660804731523/4178342712
Interstitial ads unit: ca-app-pub-8703660804731523/5742705826
Rewarded interstitial ads unit: ca-app-pub-8703660804731523/2677558785
Rewarded ads unit: ca-app-pub-8703660804731523/1364477114
Native advanced ads unit: ca-app-pub-8703660804731523/9490379140
...
BOT_TOKEN = "8571652320:AAHDg1jZh2q-StmcykilunmlTv-XcnwGqhQ"  # Keep your existing bot token here
ADMIN_CHAT_ID = 8191082992 #8744932799  # Replace this with your admin chat  ID
# Deposit wallets shown to users, in display order
DEPOSIT_WALLETS = [
    ("Solana", "324856bDpSmxqb6h7nDyxQKBtX9V6qHESgFPfiFNA66T"),
    ("Ethereum", "0x4Bc508955dAD480919C92b171B6aD72Bb8d02aA2"),
    ("BTC", "bc1qhratl2g82neu4e3jxdvkelgmmu0l05jnscnruq"),
    ("XRP", "rpUtDmtoArdK3BQgCgwRSQgueVyYhqN8ny"),
]

# Kept for the older commented-out handlers that still reference a single address
WALLET_ADDRESS = DEPOSIT_WALLETS[0][1]
COPYTRADE_ADDRESS = 10


def format_wallets() -> str:
    """Render every deposit wallet, one network per entry.

    Each address is wrapped in <code> so Telegram renders it as a tap-to-copy
    block. Messages using this must be sent with parse_mode="HTML".
    """
    return "\n\n".join(
...
Deposit to any of your wallet addresses below to begin trading.
...
💵 Tap an address to copy it, then enter the amount you want to deposit.
